...
function plot_tracer(tracer,savefig,format,legend_location)
    ...
    if (1 == isfield(tracer,'interlatency'))
        ...
        plot(tracer.interlatency.timestamp_mat',(tracer.interlatency.time_mat/1000000)','linewidth',LINEWIDTH)
    ...
    if (1 == isfield(tracer,'proctime'))
        ...
        plot(tracer.proctime.timestamp_mat',(tracer.proctime.time_mat/1000000)','linewidth',LINEWIDTH)
    ...
    if (1 == isfield(tracer,'scheduling'))
        ...
        plot(tracer.scheduling.timestamp_mat',(tracer.scheduling.time_mat/1000000)','linewidth',LINEWIDTH)
